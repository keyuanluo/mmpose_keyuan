...
def parse_args():
    ...
    parser.add_argument('config',default='td-hm_hrnet-w48_8xb32-210e_coco-256x192.py' , help='Config file')
    parser.add_argument('checkpoint',default='td-hm_hrnet-w48_8xb32-210e_coco-256x192-0e67c616_20220913.pth', help='Checkpoint file')
